...
void loop() {
  ...
  double Irms2 = acOutput2.calcIrms(1480);  // Calculate Irms only
    ...
    waterLevel    = getUltraSoundDistance();
  ...
  if(Serial.available() > 0){
    ...
    Serial.print("Temp1:  ");
    Serial.println(VALUE_TEMP_PANEL_1);
    Serial.print("Temp2:  ");
    Serial.println(VALUE_TEMP_PANEL_2);
    Serial.print("Temp env:  ");
    Serial.println(VALUE_TEMP_ENV);
    
    Serial.print("Wind:  ");
    Serial.println(VALUE_FLUX_IN);  
    Serial.print("Pump flow:  ");
    Serial.println(VALUE_FLUX_OUT);
  
    Serial.print("Pressure in  ");
    Serial.println(VALUE_PRESSURE_IN);
    Serial.print("Pressure middle  ");
    Serial.println(VALUE_PRESSURE_MIDDLE);
    Serial.print("Pressure out  ");
    Serial.println(VALUE_PRESSURE_OUT);
  
    Serial.print("Flood:  ");
    Serial.println(VALUE_FLOODING_STATUS);
    
    Serial.print("cc ");
    Serial.println(VALUE_CC);
    Serial.print("ac1 ");
    Serial.println(VALUE_AC1);
    Serial.print("ac2 ");
    Serial.println(VALUE_AC2);
    Serial.println();
  }
