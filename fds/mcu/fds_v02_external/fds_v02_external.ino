...
void loop() {
  ...
  VALUE_TEMP_PANEL_1 = (OUT_REG_TYPE)  (tempPanel1 + 128);
  VALUE_TEMP_PANEL_2 = (OUT_REG_TYPE)  (tempPanel2 + 128);
  VALUE_TEMP_ENV     = (OUT_REG_TYPE)  (tempEnv    + 128);
  VALUE_WIND         = (OUT_REG_TYPE)  wind; 
  VALUE_PYRO         = (OUT_REG_TYPE)  pyro >> 2; // guadagno LM358?
